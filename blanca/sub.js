var REST_URL = "http://www.proyectos.arcelia.net/bigg/src/public/";
                            ...
                            if (celdas[i] == "matricula") {
                                ...
                                switch (celdas[i]) {
                                    ...
                                    case "detalle":
                                        ...
                                        btnCalif.classList.add('btn', 'btn-dark', 'btn-sm');
                                        btnCalif.textContent = 'Calif';
                                        btnCalif.href = "MostrarCalificaciones.html" + "?matricula=" + alumno.clave_alu;
...
function ActualizarEval(id, materia) {
    const valores = window.location.search;
    const urlParams = new URLSearchParams(valores);
    var usmethod = "PUT";
...
function MostrarCalificaciones(idT) {
    if (checkCookie(COOKIE_NAME)) {
        var matricula = getQueryVariable("matricula");
        nRow = 1;
        var tabla = document.getElementById(idT);
                            ...
                            if (celdasCalif[i] == "nombre") {
                                ...
                                switch (celdasCalif[i]) {
                                    ...
                                    case "detalle":
                                        ...
                                        var btnEdit = document.createElement('a');
                                        btnEdit.classList.add('btn', 'btn-succes', 'btn-sm');
                                        btnEdit.textContent = 'modificar';
                                        btnEdit.onclick = function() {
                                            console.log("este es el valor de edit: " + calificacion.id);
                                            ActualizarEval(calificacion.id, calificacion.clave_mat);
                                        };

                                        var btnDel = document.createElement('a');
                                        btnDel.classList.add('btn', 'btn-primary', 'btn-sm');
                                        btnDel.textContent = 'eliminar';
                                        btnDel.href = "Borrar.html" + "?idC=" + calificacion.id;
